...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card shadow-sm">
            <div class="card-header bg-warning text-dark">Edit Berita Kesehatan</div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <div class="alert alert-info small py-2 mb-3">
                    <i class="fas fa-info-circle me-1"></i> Jika Anda menambahkan gambar atau video baru di bawah ini, media lama akan tergantikan. Kosongkan jika tidak ingin mengubah media saat ini.
                </div>
